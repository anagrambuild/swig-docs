...
<Warning>
  ...
  `NEXT_PUBLIC_*`. Route browser and mobile traffic through your own backend,
  or use the [Developer SDK server route adapters](/developer-sdk/server-route-adapters),
  which keep the key server-side for you.
</Warning>
