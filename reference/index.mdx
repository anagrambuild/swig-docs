...
- **EVM:** [Create and operate wallets](/evm) from TypeScript, Rust, or Python,
  with Viem and permissionless.js examples for sponsored transfers.
- **Solana:** Start with the [TypeScript quickstart](/tutorials/typescript) or
  [Rust packages](/reference/rust).

## What lives here

| Surface | Use it for |
| :--- | :--- |
| EVM packages in `swig-protocol-sdk` | TypeScript, Rust, and Python bindings, codecs, and smart-account adapters |
| Solana TypeScript packages in `swig-ts` | browser apps, backend services, and scripted integrations |
| Solana Rust packages in `swig-wallet` | backend services, CLI tooling, and lower-level protocol integrations |
