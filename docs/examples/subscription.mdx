...
The complete code for this example can be found in the \`examples/subscription\` directory. To run it:

1. Clone the repository
2. Install dependencies
3. Run the example:
   \`\`\`bash
   npm run subscription-example
   \`\`\`

## Next Steps

- Explore the [SWIG SDK Example Repository](https://github.com/anagrambuild/swig-rs-sdk-example) for a complete implementation
- Join our [Discord community](https://discord.gg/swig) for support
- Check out our other examples for more SWIG use cases 