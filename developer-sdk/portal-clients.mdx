...
| :--- | :--- | :--- | :--- | :--- | :--- |
| `@swig-wallet/developer-sdk` | current | prepare-first hosted wallet flows | `swig.wallets.getPolicy()` returns raw policy metadata | wallet creation, transfers, swaps, custom preparation, wallet reads, ramp, sponsor flow | prepared transactions and signing metadata |
...
- build Next.js, NestJS, or Python proxy routes around Swig actions
