---
title: "Manage Authorities and Actions"
---

This tutorial adds multiple authorities to a Swig wallet and assigns each one a
...
In [Create a Wallet](./create), you created a basic Swig wallet. This page
builds on that by adding multiple authorities with different permissions.
