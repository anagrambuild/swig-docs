...
// Create and sign a transfer transaction (use swigWalletAddress)
...
// Prepare transfer instruction (0.1 SOL, use swigWalletAddress)
const transferIx = {
...
**Classic Examples:**
- [`examples/basic/classic/using-viem.ts`](https://github.com/anagrambuild/swig-ts/blob/main/examples/basic/classic/using-viem.ts) - Viem integration
- [`examples/basic/classic/transfer-secp-session.ts`](https://github.com/anagrambuild/swig-ts/blob/main/examples/basic/classic/transfer-secp-session.ts) - Session-based authorization
- [`examples/basic/classic/transfer-secp.ts`](https://github.com/anagrambuild/swig-ts/blob/main/examples/basic/classic/transfer-secp.ts) - Basic secp256k1 usage

**Kit Examples:**
- [`examples/basic/kit/using-viem.ts`](https://github.com/anagrambuild/swig-ts/blob/main/examples/basic/kit/using-viem.ts) - Viem integration with Kit
- [`examples/basic/kit/transfer-secp.ts`](https://github.com/anagrambuild/swig-ts/blob/main/examples/basic/kit/transfer-secp.ts) - Secp256k1 example with Kit
