...
<Note>
  ...
  [Developer SDK Overview](/developer-sdk).
...
endpoint or its older portal clients. Use [Developer SDK Overview](/developer-sdk)
for the current product surface.

For the current hosted operation flows after wallet creation, see
[Transfers, Swaps, and Signing](/developer-sdk/transfers-swaps-and-signing) and
[Guardian and Recovery Flows](/developer-sdk/recovery-flows).
