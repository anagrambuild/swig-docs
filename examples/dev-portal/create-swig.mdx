...
<Note>
  ...
  start with [What the Developer SDK Does](/developer-sdk).
...
endpoint or its older portal clients. Use [What the Developer SDK Does](/developer-sdk)
for the current product surface.

For the current hosted operation flows after wallet creation, see
[Transfers and Swaps](/developer-sdk/transfers-swaps-and-signing) and
