...
<Note>
  ...
  new documentation and new integrations. The current
  <code>@swig-wallet/developer-sdk</code> package is optimized for prepared
  wallet operations. It does expose
