---
title: "Portal Admin"
sidebarTitle: "Portal Admin"
---

The Swig Developer Portal is your central hub for managing API access, policy templates, and wallet creation. Whether you're building a dApp, integrating Swig wallets, or setting up transaction sponsorship, the portal provides the tools you need.

<Note>
  The developer portal is the access layer for the hosted Swig developer
  product surface. If you are looking for the prepare-first API-key SDK
...
- **Create policy templates** that combine signers and permissions for wallet creation
- **Create Swig wallets** programmatically using your saved templates
...
<CardGroup cols={2}>
  ...
  <Card title="Policy Templates" icon="shield" href="/examples/dev-portal/create-policy">
    Save configuration for wallet creation
  </Card>
