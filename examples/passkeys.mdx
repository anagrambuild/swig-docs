...
- **[secp256r1 Transfer Example](https://github.com/anagrambuild/swig-ts/blob/main/examples/basic/classic/transfer-r1.ts)** - Complete implementation using secp256r1 keys for transfers with LiteSVM testing
...
const swigAccountAddress = findSwigPda(new Uint8Array(32));
...
const swig = await fetchSwig(svm, swigAccountAddress);
const swigWalletAddress = await getSwigWalletAddress(swig);

// Use for signing other instructions (use swigWalletAddress for transfers)
...
<Card title="secp256r1 Transfer Example" icon="code" href="https://github.com/anagrambuild/swig-ts/blob/main/examples/basic/classic/transfer-r1.ts">
