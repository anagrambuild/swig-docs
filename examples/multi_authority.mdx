...
- [Classic Example](https://github.com/anagrambuild/swig-ts/blob/main/examples/classic/transfer/multi-add-authorities-svm.ts)
...
- [Complete multi-authority example](https://github.com/anagrambuild/swig-ts/blob/main/examples/classic/transfer/multi-add-authorities-svm.ts)
