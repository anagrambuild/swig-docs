...
- **Classic SDK**: [subscription.ts](https://github.com/anagrambuild/swig-ts/blob/main/examples/basic/classic/subscription.ts) (uses LiteSVM for testing)
- **Kit SDK**: [subscription.ts](https://github.com/anagrambuild/swig-ts/blob/main/examples/basic/kit/subscription.ts) (uses local validator)
